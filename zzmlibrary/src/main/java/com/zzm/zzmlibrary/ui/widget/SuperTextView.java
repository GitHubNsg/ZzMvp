...
public class SuperTextView extends AutoRelativeLayout {
    ...
    private void initTopLine(int lineMargin) {
        ...
        topLineParams.addRule(AutoRelativeLayout.ALIGN_PARENT_TOP, TRUE);
    ...
    private void initBottomLine(int lineMargin) {
        ...
        bottomLineParams.addRule(AutoRelativeLayout.ALIGN_PARENT_BOTTOM, TRUE);
    ...
    private void initCenterBaseLine() {
        ...
        centerBaseLineParams.addRule(AutoRelativeLayout.CENTER_VERTICAL, TRUE);
    ...
    private void initLeftIcon() {
        ...
        leftImgParams.addRule(AutoRelativeLayout.CENTER_VERTICAL, TRUE);
    ...
    private void initLeftText() {
        ...
        leftTextParams.addRule(AutoRelativeLayout.CENTER_VERTICAL, TRUE);
        leftTextParams.addRule(AutoRelativeLayout.RIGHT_OF, R.id.sLeftIconId);
    ...
    private void initLeftTopText() {
        ...
        leftTopTextParams.addRule(AutoRelativeLayout.ABOVE, R.id.sCenterBaseLineId);
        leftTopTextParams.addRule(AutoRelativeLayout.RIGHT_OF, R.id.sLeftIconId);
    ...
    private void initLeftBottomText() {
        ...
        leftBottomParams.addRule(AutoRelativeLayout.BELOW, R.id.sCenterBaseLineId);
        leftBottomParams.addRule(AutoRelativeLayout.RIGHT_OF, R.id.sLeftIconId);
    ...
    private void initLeftBottomText2() {
        ...
        leftBottomParams2.addRule(AutoRelativeLayout.BELOW, R.id.sCenterBaseLineId);
        leftBottomParams2.addRule(AutoRelativeLayout.RIGHT_OF, R.id.sLeftBottomTextId);
    ...
    private void initCenterText() {
        ...
        centerTextParams.addRule(AutoRelativeLayout.CENTER_IN_PARENT, TRUE);
    ...
    private void initRightText() {
        ...
        rightTextParams.addRule(AutoRelativeLayout.CENTER_VERTICAL, TRUE);
        rightTextParams.addRule(AutoRelativeLayout.RIGHT_OF, R.id.sLeftTextId);
        if(rightIconRes!=null){
            rightTextParams.addRule(AutoRelativeLayout.LEFT_OF, R.id.sRightIconId);
        }else{
            rightTextParams.addRule(AutoRelativeLayout.ALIGN_PARENT_RIGHT, TRUE);
        }
    ...
    private void initRightIcon() {
        ...
        rightImgParams.addRule(AutoRelativeLayout.CENTER_VERTICAL, TRUE);
    ...
    private void initRightCheckBox() {
        ...
        rightCheckBoxParams.addRule(AutoRelativeLayout.CENTER_VERTICAL, TRUE);
