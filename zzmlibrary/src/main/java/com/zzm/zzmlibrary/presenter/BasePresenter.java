...
public class BasePresenter {
    ...
    public void postRequest(String url,String[][] body,StringCallBack callBack){
        ...
        OkHttpUtils.postString().url(url).mediaType(MediaType.parse("application/json; charset=utf-8")).tag(url).content(new Gson().toJson(paramMap)).build().execute(callBack);
    }
