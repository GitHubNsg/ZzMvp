...
public class TDevice {
  ...
  /*  public static String getUdid() {
    ...
    public static boolean hasInternet(Context context) {
        boolean flag;
        flag = ((ConnectivityManager) context.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo() != null;
        return flag;
    }
    ...
    public static boolean isTablet() {
        if (_isTablet == null) {
            boolean flag;
            flag = (0xf & BaseApplication.getInstance().getResources().getConfiguration().screenLayout) >= 3;
    ...
    public static void toogleSoftKeyboard(View view) {
        ((InputMethodManager) BaseApplication.getInstance().getSystemService(
                Context.INPUT_METHOD_SERVICE)).toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
    }
    ...
    public static void gotoMarket(Context context, String pck) {
        if (!isHaveMarket(context)) {
            UIUtils.showToast("你手机中没有安装应用市场！");
            return;
        }
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_VIEW);
    ...
    public static void fackIMEI() {
//        BaseApplication.setIMEI(getRandomString(18));
    }
